...
<body>
    <header style="background-color: black;">
        <div class="container">
            <div class="logo"> 
                <a href="index.php">
                    <img src="../admin/assets/image/<?php get_website_logo('Header')?>" width="170px" alt="">
                    <!-- <h3>JONGDENG NEWS</h3> -->
                </a>
            </div>
            <ul class="menu">
                ...
                <li class="menu-sport"><a href="javascript:viod(0)">ENTERTAINMENT</a>
                    <ul class="sub-menu sport">
                        <li>
                            <a href="entertianment-news-national.php">National</a>
                        </li>
                        <li>
                            <a href="entertianment-news-international.php">International</a>
                        </li>
                    </ul>
                </li>
